        ...
        <div className='bg-black text-white mt-20 p-2 md:p-0'>
            <div className="w-full md:w-1/2 text-center mx-auto py-8">
                <div className="border-b border-dotted py-10 space-y-5">
                    ...
                    <p className="text-zinc-400 font-inter">Whether you are looking to advance your career, learn a new skill, or explore new interests, our comprehensive course offerings are designed to help you achieve your goals.</p>
